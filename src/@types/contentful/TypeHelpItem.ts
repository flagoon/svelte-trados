...
export function isTypeHelpItem<Modifiers extends ChainModifiers, Locales extends LocaleCode>(entry: Entry<EntrySkeletonType, Modifiers, Locales>): entry is TypeHelpItem<Modifiers, Locales> {
    return entry.sys.contentType.sys.id === 'helpItem'
}
